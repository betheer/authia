...
const EXPECTED_COLUMNS = {
  ...
  password_reset_tokens: ['id', 'token_hash', 'normalized_email', 'expires_at', 'consumed_at'],
  email_verification_tokens: ['id', 'token_hash', 'normalized_email', 'expires_at', 'consumed_at'],
  verified_emails: ['normalized_email', 'verified_at']
};
